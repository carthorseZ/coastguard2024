...
namespace CoastGuardWeb.css.Reporting.Reports {
    ...
    public class TripReport2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CoastGuardWeb.css.Reporting.Reports.TripReport2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedTripReport2 : Component, ICachedReport {
        
        public CachedTripReport2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            TripReport2 rpt = new TripReport2();
            rpt.Site = this.Site;
            return rpt;
        }
